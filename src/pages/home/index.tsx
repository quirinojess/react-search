...
export function Home() {
 const [initialData, setInitalData] = useState<Array<IData>>([]);
 const [searchResults, setSearchResults] = useState<Array<IData>>([]);

 async function loadData() {
  const result = await searchService.getData();
 ...
 return (
  <div className={styles.content}>
   ...
   <div className={styles.contentDocumentation}>
    ...
    <p>
     <strong>loadData </strong>- Makes the call to the API that returns the
     initial list options (initialData).
    </p>
    <CodeBlock
     theme={dracula}
     text="   // call API
     async function loadData() {
      const result = await searchService.getFruits();
      setInitalData(result);
      setSearchResults(result);
     }
  ...
  "
    ...
    />
    <p>
     <strong>setInitialData</strong>- State which stores the initial values
    </p>
    <CodeBlock
     theme={dracula}
     text="  
  ...
  "
    ...
    />
    <p>
     <strong>setSearchResults </strong>- State wich stores the search values
    </p>
    <CodeBlock
     theme={dracula}
     text=" 
  ...
  "
    ...
    <table className={styles.contentTable}>
     ...
     <tbody>
      ...
      <tr>
       <td>searchResults</td>
       <td className={styles.contentDocumentationHighlight}>data[]</td>
       <td>search results data values</td>
      </tr>
      <tr>
       <td>setSearchResults</td>
       <td className={styles.contentDocumentationHighlight}>set State</td>
    ...
    <p>
     <strong>initiaData.map</strong>- Data list rendering
    </p>
    <CodeBlock
     theme={dracula}
     text="  
  ...
  "
    ...
    <CodeBlock
     theme={dracula}
     text="    function handleChange(e: ChangeEvent<HTMLInputElement>) {
  ...
  "
    ...
    <CodeBlock
     theme={dracula}
     text="    // useRef is used to clear input
  ...
  "
    ...
    />
    <p>
     <strong>Search </strong>- The Component
    </p>
    <CodeBlock
     theme={dracula}
     text="  <div className={styles.search}>
  ...
  "
   ...
   <div className={styles.git}>
    <Icons.git />
    <a target="_blank" href="https://github.com/quirinojess/react-search">
     See in Git Hub
    </a>
   </div>
  </div>
